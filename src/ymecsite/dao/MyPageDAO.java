...
public class MyPageDAO {
	...
	public ArrayList<MyPageDTO> getMyPageUserInfo
		...
		String sql =
			"SELECT ubit.id, iit.item_price, ubit.totla_price, ubit.total_count, ubit.pay, ubit.insert_date"
			+ "FROM user_buy_item_transaction ubit"
			+ "LEFT JOIN item_info_tarnsaction iit"
